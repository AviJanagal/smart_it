    ...
    <div class="tab-content " id="nav-tabContent">
        ...
        <div class="tab-pane fade " id="nav-Services" role="tabpanel" aria-labelledby="nav-Services-tab">
            <div class="main-table">
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-innerdata attendencetableinnerdata">
                    ...
                    <div class="bank-innersection">
                        <div class="table-title-add">
                            ...
                            <form  method="post" action="{{ route('admin.attendance_filter',$employee->id)}}" id="filterForm" enctype="multipart/form-data">
                                <div class="row attendencefiltercss">
                                    @csrf
                                    <div class="col-sm-2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="bank-innersection">
                                ...
                                @else                 
                                    <h1 class="nodatafoundheading nodataattendencetab">No data found</h1>
                                @endif
                            </div>
                        </div>
                    </div>
                ...
                <div class="bank-innersection">
                    <div class="table-title-add">
                        <form  method="post" action="{{ route('admin.activity_filter',$employee->id)}}" id="filterForm" enctype="multipart/form-data">
                            <div class="row activityfiltercss">
                                @csrf
                                <div class="col-sm-2">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="table-innerdata attendencetableinnerdata">
                            ...
                            @else                 
                                <h1 class="nodatafoundheading nodataactivitytab">No data found</h1>
                            @endif
                        </div>
                    </div>
                </div>
