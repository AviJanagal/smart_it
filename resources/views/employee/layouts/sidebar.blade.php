<div class="sidemenubar">
	...
	<nav>
		<ul >
			...
			<li>
				<a href="{{route('employee.graphs')}} " class="{{ (request()->is('employee.graphs')) ? 'active' : '' }}"> <span class="icon "><i class="fa fa-server" aria-hidden="true"></i></span> <span class="title ">Graphs</span> </a>
			</li>			
		</ul>
	</nav>
</div>