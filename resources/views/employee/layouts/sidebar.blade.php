                ...
                <nav class="navbar navbar-expand-lg navbar-light navbarcustome">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{in_array(Route::currentRouteName(),['employee.attendance_filter','employee.attendance_history']) ? 'active' : '' }}" href="{{route('employee.attendance_history')}} ">
                                    Attendance History
                                </a>
                            </li>
                            <li class="nav-item dropdown owndropdown">
                                <a
                                    class="nav-link dropdown-toggle {{in_array(Route::currentRouteName(),['employee.daily_activity','employee.all_daily_activities','employee.activity_filter']) ? 'active' : '' }}"
                                    href="#"
                                    id="navbarDropdown"
                                    role="button"
